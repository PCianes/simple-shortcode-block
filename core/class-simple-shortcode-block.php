 ...
 * @subpackage Simple_Shortcode_Block/core
 */
...
class Simple_Shortcode_Block {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Simple_Shortcode_Block_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'simple-shortcode-block';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'core/class-simple-shortcode-block-loader.php';
		 ...
		 */
		$this->loader = Simple_Shortcode_Block_Loader::get_instance();
	 ...
	 *
	 * Uses the Simple_Shortcode_Block_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Simple_Shortcode_Block_I18n( $this->plugin_name );
	...
	private function define_gutenberg_hooks() {
		...
		$this->loader->add_action( 'enqueue_block_editor_assets', $plugin_gutenberg, 'enqueue_all_blocks_assets_editor', PHP_INT_MAX );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Simple_Shortcode_Block_Loader    Orchestrates the hooks of the plugin.
	 */
