...
export default registerBlockType(
    'simple-shortcode-block/inspector-control-fields',
    {
        title: __( 'Example - Inspector Fields', 'simple-shortcode-block' ),
        description: __( 'An example of how to use form fields in the Inspector element.', 'simple-shortcode-block'),
        ...
        keywords: [
            __( 'Palette', 'simple-shortcode-block' ),
            __( 'Settings', 'simple-shortcode-block' ),
            __( 'Scheme', 'simple-shortcode-block' ),
        ],
        attributes,
